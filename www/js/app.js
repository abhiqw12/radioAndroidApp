...
(function(){
  ...
  app.controller('radioController', function($scope, $sce, ngAudio){
    ...
    $scope.radioHost = 'http://s10.voscast.com'; // Replace this with your own radio stream URL
    $scope.radioPort = '9756'; // Replace this with the port of your Radio Stream
    ...
    $.SHOUTcast({
       host : 's10.voscast.com', // Replace this with your own radio stream URL but remove the http
